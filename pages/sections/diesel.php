...
if(isset($_POST["sbt"])){
 /////////////////////////////
  ...
  $sql2="UPDATE `oil_stock` SET `ltr`=`ltr`-$ltrupd,`preby`='$preby',`time_date`='$timeDate' WHERE cat='$conv' and `site`='$Plantsite'";
...
$sql="insert into `history`(PlantNo,time_date,liter,requi,loadcarry,unit,info,lprice,pre_by,assetID,title,site,itemSerial)values('$plantNo','$timeDate','".mysqli_real_escape_string($config,$_POST["liter"])."','".mysqli_real_escape_string($config,$_POST["requi"])."','".mysqli_real_escape_string($config,$_POST["loadc"])."','".mysqli_real_escape_string($config,$_POST["unit"])."','".mysqli_real_escape_string($config,$_POST["desc"])."','".mysqli_real_escape_string($config,$_POST["lprice"])."','$preby','$ids','$dp','$site','$tenDgt')";
  ...
  $msg="<font color='green'>($liter) Liter of $dp has been allocated to <u>$plantNo</u></font>";
   echo    "<script>setTimeout(function(){window.location='diesel.php?v=$ids';},4200);</script>";
  }
 }
?>
<style type="text/css">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header"> 
              <h3 class="box-title"><a href="#"><a href="#"><?php echo "Diesel Distribution ---".$plantNo."---".$dp ?></a></h3>

            <h3 class="box-title" style="float: right;"><a href="#"><a href="#"><?php echo "Available ".$dp." in Stock ("."<font color='red'><b>".number_format($row_oil_count[$conv])."L</b></font>)"; ?></a></h3>
          </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <img src="pace/diesel.png" style="height:25%; padding-top:50px;" class="hidden-mobile">
...
<div class="form-group">
             <div class="form-wrapper">
              ...
              <input type="hidden" name="dp" value="<?php echo $row_oil_count[$conv]; ?>" id="dp">
            </div>
 <div class="form-wrapper">
