         ...
         if (isset($_FILES['attachement']) && $_FILES['attachement']['tmp_name'] != '') {
              ...
              if (in_array($file_ext, ['jpg', 'jpeg', 'png', 'gif'])) {
                  ...
                  if ($file_ext === 'jpg' || $file_ext === 'jpeg') {
                      ...
                      imagejpeg($source_image, $dir_path, 100); // 75 is the quality, adjust as needed
                  } elseif ($file_ext === 'png') {
...
mail("ronaldo@rocad.com,rene@rocad.com,tamer@rocad.com,umar@rocad.com,deleakintayo@rocad.com","Advance_voucher (".($row_preby['fullname'])." Ref: ".$dt.")",$msgMail);
  ...
  <div class="wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active" ><a href="move.php">Request Structural Asset</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-header"> 
              ...
              <h3 class="box-title"><a href="#"><a href="advance_voucher.php"><?php echo "Request Structural Asset" ?></a></h3>
...
<li>
        ...
        <!--<li>
          ...
          <label for="">A/C Code:</label><select name="plantno" class="form-control"><option value="" selected>::Select Plant No::</option><option value="">N/A</option><?php while($row_asset=mysqli_fetch_assoc($asset)){?><option value="<?php echo $row_asset['sortno']; ?>"><?php echo $row_asset['sortno']; ?></option><?php }?></select>
         ...
         <li> <label for="">Upload Voucher:</label>
