...
$qryasset="SELECT * FROM `storeloadingdetails` where id is not null AND status=5 $mysql";
$assets=mysqli_query($config,$qryasset) or die(mysqli_error($config));

$qry_record = mysqli_query($config, "SELECT COUNT(*) AS total_record FROM `storeloadingdetails` where id is not null AND status=5 $mysql");
  ...
  <div class="wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Completed invoices</li>
      </ol>
    </section>
	...
	<center><h3 class="box-title"><?php  echo $msg; ?></h3></center>
        <div class="box-header">
           ...
           <table id="dataTable1" class="table table-bordered table-hover w-100">
                <caption>
                  <h2 style="text-align: center" class="box-title"><font color="darkgreen"> COMPLETED REPORT <?php echo $title ?></font></h2> 
                     <h3 style="text-align: center" class="box-title"><font color="darkgreen"> TOTAL COMPLETED : <?php echo number_format($total_record,2); ?></font></h3> 
