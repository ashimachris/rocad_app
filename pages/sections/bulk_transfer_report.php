...
if (isset($_GET['f'], $_GET['t'])) {
    ...
    // $mysql = " AND (DATE(date) >= DATE_SUB(CURDATE(), INTERVAL 1 MONTH))";
...
$qry_transfer = "SELECT * FROM `bulk_transfer` WHERE id IS NOT NULL $mysql ORDER BY id DESC";
...
$qry_amount = mysqli_query($config, "SELECT SUM(amount) AS total_amount FROM `bulk_transfer` WHERE id IS NOT NULL $mysql");
...
<body class="hold-transition skin-blue sidebar-mini">
          ...
          <div class="table-responsive">
                <table id="dataTable1" class="table table-bordered table-hover w-100">
                    ...
                    <h2 style="text-align: center" class="box-title">
                        <font color="darkgreen">BULK TRANSFER REPORT <?php echo $title; ?></font>
                    </h2>
                    ...
                    ?>
                        ...
                        <td>
                            ...
                            <?php echo $row_transfer['reference']; ?>
                        </td>
                        
                        <td><?php echo $row_transfer['sender']; ?></td>
                        ...
                        <td><?php echo $row_transfer['bank_name']; ?></td>
  ...
  <div class="modal-content">
    ...
    <center>
      <!-- Filter form -->
      <form method="GET" action="bulk_transfer_report.php">
        <table>
          <tr>
            <th>From:</th>
            <td>&nbsp;&nbsp;&nbsp;</td>
