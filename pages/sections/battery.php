...
if(isset($_POST["sbt"])){
  for($i=0; $i<$number; $i++)
  {
    ...
    {
 /////////////////////////////
$sql="insert into `history`(PlantNo,time_date,itemName,lprice,supl,suplPhone,info,pre_by,assetID,title,site,itemSerial,bamps,tsno,requi)values('$plantNo','$timeDate','".mysqli_real_escape_string($config,$_POST["itemName"][$i])."','".mysqli_real_escape_string($config,$_POST["amount"][$i])."','".mysqli_real_escape_string($config,$_POST["supl"])."','".mysqli_real_escape_string($config,$_POST["suplPhone"])."','".mysqli_real_escape_string($config,$_POST["info"])."','$preby','$ids','Battery','$site','$tenDgt','".mysqli_real_escape_string($config,$_POST["bamps"][$i])."','".mysqli_real_escape_string($config,$_POST["tsno"][$i])."','".mysqli_real_escape_string($config,$_POST["requi"])."')";
  ...
  $msg="<font color='green'>Data successfully Saved --- <u>$plantNo</u></font>";
   echo    "<script>setTimeout(function(){window.location='battery.php?v=$ids';},4200);</script>";
  }
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header"> 
              <h3 class="box-title"  ><a href="#"><a href="#"><?php echo "Battery for ".$row_assets['sortno']; ?></a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <img src="pace/battery.png" style="height:25%; padding-top:50px;" class="hidden-mobile">
...
<li>
   ...
   <div class="form-group">
            <div class="form-wrapper">
             ...
             <div class="form-wrapper">
              ...
              <input type="text" class="form-control" required value="<?php echo $row_assets['nofb'] ?>" name="sortno" disabled>
            </div>
              </div></li>            
                   <li>
   ...
   <div class="form-group">
            <div class="form-wrapper">
             ...
             <div class="form-wrapper">
              ...
              <input type="text" class="form-control" required value="<?php echo $row_site['site_loc']; ?>" name="sortno" disabled>
            </div>
              </div></li>     
              <li>
   ...
   <div class="form-group">
        ...
        <hr><h5 class="box-title"><span style="color:#337ab7;"><?php echo "BATTERY INFORMATION" ?></span></h5>
        <table class="table table-bordered txt" id="dynamic_field" border="0" >
              <tr>
                <td align="right" colspan="6">  
                                    <button type="button" name="add" id="add" class="btn btn-success">Add Battery</button></td>
                </tr>
          </table>
                <div align="right">
