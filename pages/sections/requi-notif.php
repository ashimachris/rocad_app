...
$sender = $row_preby['fullname'];
 ...
 // $authbyID=$prebyID;require '../layout/authby.php';
 // $sender1 = $row_authby['fullname']; 
?>
...
////////////////////
    ...
    switch($action){case 0:$sts="Pending";break;case 1:$sts="Denied";break;case 2:$sts="Approved";break;default:$sts="Unknown";}
    ...
    $fetch_details = mysqli_query($config, "SELECT * FROM `storeloadingdetails` WHERE reference='$reference'");

    if ($fetch_details) {
        $row_data = mysqli_fetch_assoc($fetch_details);
        $reqfor = $row_data['reqfor'];
      }


    // send mail here
    $to = "deleakintayo@rocad.com,ronaldo@rocad.com,rene@rocad.com,umar@rocad.com,tamer@rocad.com,ibrahim.labaran@rocad.com";
...
mail($row_preby['user_mail'],"Requisition Response".$dt,$msgMail);*/
          ...
          <div class="box">
            ...
            <div class="box-header">
              ...
              <td width="161" rowspan="6" valign="top" <?php allow_access(1,1,0,0,0,0,$usergroup); ?>><font color="blue">Note:</font> <br><form action="" method="post" id="denied"><input type="hidden" name="denied" id="act"><input type="hidden" name="mysqls2" value="<?php echo $authby=',authby='.$preby; ?>"><textarea placeholder="<?php echo $row_notii['note']; ?>" required name="note"></textarea><input type="submit" name="ok" id="ok" style="display:none"></form><br><br><center>Action<br>
                ...
                <!-- <span class="label label-warning" <?php allow_access(1,0,0,0,0,0,$usergroup); ?> style="cursor:pointer" id="approveToExpense">Approve to Expense</span> -->
              </center><br><br>
              ...
              <span class="label label-success" style="cursor:pointer" id="status-label">Received</span>

                    <script>
                      document.getElementById('status-label').addEventListener('click', function() {
                        alert('Success');
                        window.location.href = '/rocad_admin/pages/dashboard/';
                      });
                    </script>
              ...
              <td><div align="right">Department:</div></td>
               ...
               <td  colspan="8"><?php $siteID=$row_notii['dept'];require '../layout/site.php'; echo $row_dept['dname']; ?></td>
              ...
              <td><div align="right">Required for:</div></td>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-hover">
                ...
                <td><?php echo $row_noti1['qty']; ?></td>
                 ...
                 <td><?php echo $row_noti1['infoD']; ?></td>
                 ...
                 <td style="cursor: pointer;"><div class="dropdown"><button class="dropbtn" <?php allow_access(1,1,0,0,0,0,$usergroup); ?>>Modify</button>
                  ...
                  <a href="modify_req.php?v=<?php echo $row_noti1['id'];?>">Edit</a>
                 <a style="cursor: pointer;" target="_blank" href="<?php echo $row_noti1['invoice'];?>">Invoice</a>
