...
$ad=false;
if(isset($_GET['t'])and (!empty($_GET['t']==d))){
$ad=true;
}
...
$sum = "SELECT sum(qty) as allsum FROM `storeloadingdetails` where reference=$ids$mysql";
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
             ...
             <h3 class="box-title"><a href="print_req.php?v=<?php echo $ids."&t=".$ad;?>">PREVIEW</a></h3><!--||<a href="invoices_more.php?v=<?php echo $ids?>">View Invoice</a>-->
            ...
            <div class="box-body">
              ...
              <p class="right"><span style="color:darkred; cursor: pointer;" id="myBtn">Filter By Date</p>
                <p class="center"><span style="color:#3c8dbc;"><b>Quantity of Items Requested:</b></span> <span style="color:darkred;">#<?php echo $row_sum['allsum'];?></p>
                  </div>
                <?php }?>
                <center><?php echo "   LPO:- ".$ids; ?></center>
               <hr>
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
            <?php $j=0;while($row_assets=mysqli_fetch_assoc($as_assets)){$j++;$r=$row_assets['reference'];$req=$row_assets['reqfor'];if (preg_match('/\bDiesel\b/', $req)) { 
                  $link='diesel_stock.php?r='.$r;
                }else{$link="#";} ?>
                  <tr style="cursor:pointer" onmouseover="$(this).css('background', '#d4edda');" onMouseOut="$(this).css('background', '#FFF');" onClick="window.location='<?php echo $link; ?>'">
               ...
               <td><?php $siteID=$row_assets['dept'];require '../layout/site.php'; echo $row_dept['dname']; ?></td>
                  <td><?php if($row_assets['PlantNo']){echo $row_assets['PlantNo'];}else{echo "N/A";} ?></td>
                  <td><?php echo $row_assets['qty']; ?></td>
                  <td><?php echo $row_assets['infoD']; ?></td>
                 ...
                 <td><?php if(!empty($row_assets['recby'])){$prebyID=$row_assets['recby'];}else{$prebyID=0;}require '../layout/preby.php';echo $row_preby['fullname']; ?></td>
