...
$site_id = $_GET['v'];
$assets = "SELECT * FROM `assets` where asset_type=2 AND site='$site_id' order by sortno";
...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <?php if($row_assets['status']==2){?><a href="staff_ad.php?v=<?php echo '5assets';?>&r=<?php echo $row_assets['id'];?>&lk=<?php echo 'equipments.php';?>">Activate</a><?php }?>
