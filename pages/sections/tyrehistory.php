...
$asset = "SELECT * FROM `history` where assetID=$ids and title='Tyre' order by id desc";
$assets = "SELECT * FROM `history` where assetID=$ids$mysql and title='Tyre' order by id desc";
...
$sum = "SELECT sum(lprice) as allsum FROM `history` where title='Tyre' and assetID=$ids$mysql";
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
             <h3 class="box-title" ><a href="repairhistory.php?v=<?php echo $ids; ?>"><?php echo "Tyre History --- ".$plantNo; ?></a></h3>
            <!-- /.box-header -->
             <div class="box-body">
