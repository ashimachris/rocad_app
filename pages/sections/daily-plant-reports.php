  ...
  <div class="wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        ...
        <small>Report on the functionality of the machineries</small>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Daily Plant Reports</li>
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-header">
              ...
              <h3 class="box-title"><a href="new-plant-report.php">Create New Report</a></h3>
