...
$asset = "SELECT * FROM `history` where itemSerial=$ids and title='Tyre' order by id desc";
$assets = "SELECT * FROM `history` where itemSerial=$ids$mysql and title='Tyre' order by id desc";
...
$sum = "SELECT sum(lprice) as allsum FROM `history` where title='Tyre' and itemSerial=$ids$mysql";
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
             <h3 class="box-title" ><a href="tyredtls.php?v=<?php echo $ids; ?>"><?php echo "Tyre History --- ".$plantNo; ?></a></h3>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-hover">
                ...
                <?php $j=0;while($row_assets=mysqli_fetch_assoc($as_assets)){$j++; ?>
                  <tr style="cursor:pointer" onmouseover="$(this).css('background', '#d4edda');" onMouseOut="$(this).css('background', '#FFF');" onClick="window.location='moretyre.php?v=<?php $id=$row_assets['id'];echo $id;?>'">
                <td><?php echo "Tyre ".$j; ?></td>
                  <td><?php echo $row_assets['manuf_date']; ?></td>
                  <td><?php echo $row_assets['time_date']; ?></td>
                  <td><?php echo $row_assets['tsize']; ?></td>
