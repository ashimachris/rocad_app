...
$sql_query = "UPDATE `daily_expenses_reports` SET status=2,`bank_mail`='$banks' where `id` IN (".(implode(",", $ids)).")";
...
$.post("khadmah.php?approve_all", {ids: checked_ids,banks:banks}).done(function (data)
			{
				
				alert("Record updated successfully");
   				setTimeout(function(){window.location='khadmah.php';},4200);
			});
		}
        })
