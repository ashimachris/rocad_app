...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="returned_items.php">Returned Items</a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <p class="right"><span style="color:darkred; cursor: pointer;" id="myBtn">Filter By Date</p>
                <p class="center"><span style="color:#3c8dbc;"><b>Returned Amount:</b></span> <span style="color:darkred;">&#8358;<?php echo number_format($row_sum['allsum'],2);?></p>
                  </div>
              ...
              <table id="example1" class="table table-bordered table-hover" style=" text-transform: uppercase;">
                ...
                <tbody>
                <?php $j=0;while($row_assets=mysqli_fetch_assoc($as_assets)){$j++;$ttl=$row_assets['title']; ?>
                  <tr style="cursor:pointer" onmouseover="$(this).css('background', '#d4edda');" onMouseOut="$(this).css('background', '#FFF');" onClick="window.location='more_returned.php?f=2020-01-01&t=2080-01-01&p=&tlt=<?php echo $ttl;?>&st=&v='">
                <td><?php echo $j; ?></td>
  ...
  <div class="modal-content">
    ...
    <center><form><table>
                ...
                <th>Plant No</th>
                <td>&nbsp;&nbsp;&nbsp;</td>
                <td><select name="p" class="form-control"><option value="" selected>::Select Plant No::</option><option value="">N/A</option><?php while($row_asset=mysqli_fetch_assoc($assetQry)){?><option value="<?php echo $row_asset['id']; ?>"><?php echo $row_asset['sortno']; ?></option><?php }?></select></td>                   
                  </tr>
                  <tr>
                    <td colspan="3">&nbsp;&nbsp;&nbsp;</td>
                  </tr> 
                ...
                <th>Title</th>
                <td>&nbsp;&nbsp;&nbsp;</td>
                <td><select name="tlt" class="form-control"><option value="" selected>::Select Title::</option><option value="">Tyre</option><option>Battery</option><option>REPAIR</option></select></td>                   
                  </tr>
                  <tr>
                    <td colspan="3">&nbsp;&nbsp;&nbsp;</td>
                  </tr>
