...
$qry_details = "SELECT * FROM `storeloadingdetails` WHERE id=". $_GET['edit_id'];
...
if(isset($_POST["sbt"])){
	...
	$description = mysqli_real_escape_string($config,$_POST["reqfor"]);
    $descrip = mysqli_real_escape_string($config,$_POST["descrip"]);
    $qty = mysqli_real_escape_string($config,$_POST["qty"]);
	$edit_id = mysqli_real_escape_string($config,$_POST["edit_id"]);
  
	$sql = "UPDATE storeloadingdetails SET PlantNo='$plant_no', reqfor='$description', qty='$qty', descrip='$descrip', 
                                fromsite='$fromsite' WHERE id='$edit_id' ";
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header"> 
              <h3 class="box-title"><a href="#"><a href="requisition_report.php"><?php echo "Requisition" ?></a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
             ...
             <select class="form-control" id="fromsite" required name="fromsite">   
				...
				<div class="form-wrapper">
				    ...
				    <option value="0">Nil</option>
				        ...
				        <?php $plant_no = $row_details['PlantNo']; ?>
			        ...
			        <textarea class="form-control" name="reqfor" required>
				        <?php echo $row_details['reqfor']; ?>
			        </textarea>
			    </div>

                <div class="form-wrapper">
			        <label for="">Plant Description:</label>
			        <textarea class="form-control" name="descrip" required>
				        <?php echo $row_details['descrip']; ?>
			        </textarea>

                    <label for="">Quantity:</label>
			        <input class="form-control" name="qty" value="<?php echo $row_details['qty']; ?>" required />
