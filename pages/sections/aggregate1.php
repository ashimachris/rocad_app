  ...
  <div class="wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active" <?php allow_access(1,1,0,0,$usergroup); ?>><a href="equipments.php">Plant</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header"> 
              <h3 class="box-title" <?php allow_access(1,1,0,0,$usergroup); ?>><a href="#"><a href="daily-plant-reports.php"><?php echo "Aggregate Update" ?></a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
 ...
 <li>
             ...
             <li>
              <label for="">Category:</label>
               <select name="agcat" required class="form-control"><option value="" selected>::Select Category::</option><option>Aggregate</option><option id="btn2">Laterite</option><option>Sand</option><option>Boulder</option><option>MC1</option><option>Aspalt</option><option>Blocks</option><option>S125</option><option>Reinforcement</option></select>
            </li>
            <li>
             ...
             <li>
              <label for="">Unit:</label>
               <select name="units" required class="form-control"><option value="" selected>::Select Unit::</option><option title="Pieces">Pc</option><option title="Cubic Meter">&#13221;</option><option title="Ton">Tn</option><option title="Liter">LTR</option><option title="8 Milemeter">8mm</option><option title="10 Milemeter">10mm</option><option title="12 Milemeter">12mm</option></select>
            </li>
            <li>
            ...
            <li>
              ...
              <input type="file" class="form-control" required name="filen" title="Upload Invoice">
                      </li>             
