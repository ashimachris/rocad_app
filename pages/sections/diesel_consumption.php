...
$assets = "SELECT * FROM `oil_stock`$mysql1 order by id asc";
...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <?php allow_access_all(1,1,0,1,1,0,$usergroup); ?>
...
<div>
  ...
  <div class="modal-content">
    ...
    <center><form><table>
                ...
                <th>Title</th>
                <td>&nbsp;&nbsp;&nbsp;</td>
                <td><select name="tlt" class="form-control"><option value="" selected>::Select Title::</option><option>Diesel</option><option>Petrol</option><option>Hydraulic Oil</option><option>Engine Oil</option><option>Gear Oil</option></select></td>                   
                  </tr>
                  <tr>
                    <td colspan="3">&nbsp;&nbsp;&nbsp;</td>
                  </tr>
