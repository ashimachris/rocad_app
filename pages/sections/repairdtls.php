...
$asset = "SELECT * FROM `history` where itemSerial=$ids order by id desc";
$assets = "SELECT * FROM `history` where itemSerial=$ids$mysql order by id desc";
...
$sum = "SELECT sum(lprice) as allsum FROM `history` where itemSerial=$ids$mysql";
...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <section class="content-header">
      <h1>
        ROCAD
        <small>Maintenance Report</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title" ><a href="repairdtls.php?v=<?php echo $ids; ?>"><?php echo "Report --- ".$plantNo; ?></a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-hover" style=" text-transform: uppercase;">
                ...
                <?php $j=0;while($row_assets=mysqli_fetch_assoc($as_assets)){$j++; ?>
                  <tr style="cursor:pointer" onmouseover="$(this).css('background', '#d4edda');" onMouseOut="$(this).css('background', '#FFF');" onClick="window.location='morerepair.php?v=<?php $id=$row_assets['id'];echo $id;?>'">
                <td><?php echo $j; ?></td>
