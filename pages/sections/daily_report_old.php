...
$active_menu = "blank";
  ...
  $authbyID=$authby; require '../layout/authby.php';
...
$qryasset="SELECT * FROM `daily_expenses_reports` where id is not null $mysql";
        ...
        <div class="box-header">
            ...
            <div class="box-body">
              <button onclick="window.location='/rocad_admin/pages/sections/daily_pending.php'" style="width: 100px; height: 30px; font-size: 12px; border-radius: 10px; margin: 10px; padding: 10px 20px; background-color: #3498db; color: #fff; border: none; float:right; display: flex; justify-content: center; align-items: center;"
                ...
                <button onclick="window.location='/rocad_admin/pages/sections/daily_approve.php'" style="width: 100px; height: 30px; font-size: 12px; border-radius: 10px; margin: 10px; padding: 10px 20px; background-color: #3498db; color: #fff; border: none; float:right; display: flex; justify-content: center; align-items: center;"
                class="pending"> All approve</button>
           ...
           <table id="example1" class="table table-bordered table-hover w-100">
                ...
                <tr style="text-transform: uppercase;">
                  ...
                  <!-- <td><?php $authbyID=$row_assets['authby'];require '../layout/authby.php';echo $row_preby['fullname']; ?></td> -->

                  <td><?php if(!empty($row_assets['authby'])){
                    $authbyID=$row_assets['authby'];}
                    else{
                      $authbyID=0;echo "<span class='label label-danger'>Waiting...</span>";
                    }require '../layout/authby.php'; echo $row_authby['fname']; ?>
...
$(document).ready(function(){
	...
	$('#approve_btn').click(function(){
			...
			$.post("daily_report.php?approve_all", {ids: checked_ids}).done(function (data)
			{
