...
$sql="UPDATE `storeloadingdetails` SET reqfor='$reqfor',totalvalue='$qty',PlantNo='$PlantNo',qtyw='$qtyw',modify_by='$preby' where id='$ids'";
  ...
  $msg="<font color='green'>Data successfully Updated.</font>";
   echo    "<script>setTimeout(function(){window.location='advance-notif.php?v=$reference';},2200);</script>";
  }
    }
?>
<style type="text/css">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header"> 
              <h3 class="box-title" ><a href="#"><a href="#">Advance Voucher Update--L.P.O No.: (<?php echo $row_notii['reference']; ?>)</a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<ul>
  <li>            
              <label for="">For What Required:</label>
