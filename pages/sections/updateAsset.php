...
session_start();
 ...
 if(isset($_GET['v'])and (!empty($_GET['v']))){
  $ids=$_GET['v'];
  $groups = "SELECT * FROM `structural_asset` where id=$ids";
...
$group = "SELECT * FROM `structural_asset` where id=$ids";
...
if(isset($_POST["sbt"])){
  $asset_name=mysqli_real_escape_string($config,$_POST["asset_name"]);
  $asset_number=mysqli_real_escape_string($config,$_POST["asset_number"]);
  $asset_type=mysqli_real_escape_string($config,$_POST["asset_type"]);
  $size=mysqli_real_escape_string($config,$_POST["size"]);
  $purchase_year=mysqli_real_escape_string($config,$_POST["purchase_year"]);
  ...
  $store_keeper=mysqli_real_escape_string($config,$_POST["store_keeper"]);
  $site=mysqli_real_escape_string($config,$_POST["site"]);
  $ids=mysqli_real_escape_string($config,$_POST["ids"]);


  $upd="UPDATE `structural_asset` SET asset_name='$asset_name',asset_number='$asset_number',asset_type='$asset_type',size='$size',purchase_year='$purchase_year',qty_store='$qty_store',total_qty='$total_qty',cost='$cost',status='$status',store_keeper='$store_keeper',site='$site' where id=$ids";
  ...
  if($qry){
    ...
    $msg="<font color='green'>Data successfully Updated</font>";
     echo    "<script>setTimeout(function(){window.location='updateAsset.php?v=$ids';},4200);</script>";
    }
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="#"><a href="#"><?php echo $row_assets['asset_name']; ?></a></h3>
            </div>
               ...
               <li>   
                <div class="form-group">
                    <div class="form-wrapper">
                        ...
                        <input type="text" class="form-control" required name="asset_name" value="<?php echo $row_groups['asset_name'] ?>">
                          <input type="hidden" class="form-control" required name="ids" value="<?php echo $_GET['v'] ?>">
                    </div>
                    <div class="form-wrapper">
                        <label for="">Asset No:</label>
                        <input type="text" class="form-control" required  name="asset_number" value="<?php echo $row_groups['asset_number'] ?>">
                    </div>
                </div>
              </li>           
              <li>
                <div class="form-group">
                    <div class="form-wrapper">
                        ...
                        <input type="text" class="form-control" required  name="asset_type" value="<?php echo $row_groups['asset_type'] ?>">
                    </div>
                    <div class="form-wrapper">
                ...
                <div class="form-group">
                    <div class="form-wrapper">
                        ...
                        <input type="text" class="form-control" required  name="size" value="<?php echo $row_groups['size'] ?>">
                    </div>
                    <div class="form-wrapper">
                        <label for="">Purchase year:</label>
                        <input type="text" class="form-control" required name="purchase_year" value="<?php echo $row_groups['purchase_year'] ?>">
                    </div></li>
                <li>
                <div class="form-group">
                    <div class="form-wrapper">
                        <label for="">Quantity in Store:</label>
                        <input type="text" class="form-control" required name="qty_store" value="<?php echo $row_groups['qty_store'] ?>">
                    </div>
                    <div class="form-wrapper">
                        <label for="">Total Quantity:</label>
                        <input type="text" class="form-control" required name="total_qty" value="<?php echo $row_groups['total_qty'] ?>">
                    </div></li>
                    <li>
                      <div class="form-group">
                        <div class="form-wrapper">
                            <label for="">Store Keeper:</label>
                            <input type="text" class="form-control" required name="store_keeper" value="<?php echo $row_groups['store_keeper'] ?>">
                        </div>
                      <div class="form-wrapper">
                        <label for="">Cost of Equipment:</label>
                        <input type="text" class="form-control" required name="cost" value="<?php echo $row_groups['cost'] ?>">
                      </div></li>
                    <li>
                      <div class="form-group">
                          <div class="form-wrapper">
